...
//		Intent intent = getIntent();
        ...
        mGoBackVideo = (TextView) findViewById(R.id.textview_gobackvideo);
        mCloseVideo = (TextView) findViewById(R.id.textview_closevideo);
        mRefreshVideo = (TextView) findViewById(R.id.textview_refreshvideo);
        mPlayVideo = (TextView) findViewById(R.id.textview_playvideo);

        mGoBackVideo.setOnClickListener(new OnClickListener() {
            @Override
        ...
        mCloseVideo.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        });
        mRefreshVideo.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mWebView.reload();
            }
